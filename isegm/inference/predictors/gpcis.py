...
class BaselinePredictor(object):
    def __init__(self, model, device,
        ...
        self.with_flip = True
        if hasattr(self.net, 'set_status'):
            self.net.set_status(training=False)
    ...
    def get_prediction(self, clicker, prev_mask=None, args=None):
        ...
        pred_logits, last_click, metrics_dict = self._get_prediction(image_nd, clicks_lists, is_image_changed, gt_mask, args, self.transforms, clicker.gt_mask)
