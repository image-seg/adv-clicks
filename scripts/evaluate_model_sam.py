...
def parse_args():
    ...
    parser.add_argument('mode', choices=['NoBRS'], help='Режим предсказания маски')
...
def main():
    ...
    if args.deterministic:
        print("SAM использует недетерминированные операции (например, cumsum)!")
...
def get_predictor_and_zoomin_params(args, dataset_name):
    ...
    # SAM не использует увеличение области интереса
    zoom_in_params = None
